    ...
    <Layout style={layoutStyle}>
      <Content style={{ padding: '20px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <Title level={2} style={{ marginBottom: 0 }}>tradehub</Title>
          <Text type="secondary">基金、股票、ETF 的统一投资工作台</Text>
        </div>
      ...
      <Footer style={{ textAlign: 'center', background: 'transparent' }}>
        <Text type="secondary" style={{ fontSize: 12 }}>&copy; 2026 tradehub</Text>
      </Footer>
    </Layout>
  );
}
